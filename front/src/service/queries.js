const CITIES="SELECT DISTINCT ?object  WHERE { ?subject <http://www.dbpedia.org/ontology/city> ?object }";
...
const selectRessourceForCity = (city,resource) => {
    return `SELECT DISTINCT ?subject ?label ?lat ?lont WHERE {
     ?subject <http://www.dbpedia.org/ontology/city> <http://www.dbpedia.org/resource/${city}>.
